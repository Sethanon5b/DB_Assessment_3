...
namespace RengeGames.HealthBars {
    ...
    public class RadialSegmentedHealthBar : MonoBehaviour, ISegmentedHealthBar {
        ...
        public ShaderProperty<float> Arc { get; private set; }
        ...
        public ShaderProperty<Vector2> Offset { get; private set; }
        ...
        [SerializeField] private float _arc = 0f;
        ...
        //specifically for Unity 2019
        private static string BaseMaterialName => "RadialSegmentedHealthBarMaterialBuiltIn";
        ...
        private void InitProperties() {
            properties = new SortedDictionary<string, IShaderProperty>{
                ...
                ["Arc"] = Arc = new ShaderProperty<float>("_Arc", FloatPropertyFunc, _arc),
                ...
                ["Offset"] = Offset = new ShaderProperty<Vector2>("_Offset", VectorPropertyFunc, _offset),
        ...
        void ResetMaterialWithSerializedFields(bool ignoreDirty) {
            ...
            Arc.ApplyValueToShader(ignoreDirty, ref _arc);
            ...
            Offset.ApplyValueToShader(ignoreDirty, ref _offset);
